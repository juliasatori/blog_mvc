<?php
Core\View::render('layout/header', ['admin' => true]); ?>
<div class="container">
    <div class="row">
                    ...
                    <form action="<?= url('admin/posts/store') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <textarea name="body" id="body" rows="3"
                                      class="form-control"><?= !empty($data['body']) ? $data['body'] : '' ?></textarea>
                            <?php
                            if (!empty($data['errors']['body'])): ?>
